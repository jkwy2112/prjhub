  ...
  <el-container class="layout">
    <el-aside width="220px" class="sidebar">
      ...
      <el-menu :default-active="$route.path" router background-color="#001529" text-color="#a6adb4"
        ...
        <el-menu-item index="/approvals"><el-icon><Stamp /></el-icon>审批中心</el-menu-item>
...
import { Odometer, Folder, List, ArrowDown, Setting, Stamp } from '@element-plus/icons-vue'
...
const pageTitle = computed(() => ({ '/dashboard': '仪表盘', '/projects': '项目', '/my-tasks': '我的任务', '/approvals': '审批中心', '/admin': '系统管理' }[route.path] || 'PrjHub'))
